...
_tarot_agent: TarotAgent = None
_buffett_agent: BuffettAgent = None
...
def set_dependencies(
    ...
    tarot_agent: TarotAgent = None,
    buffett_agent: BuffettAgent = None,
):
    """Set global dependencies."""
    global _project_repo, _project_content_repo, _tweet_repo, _tweet_service, _embedding_service, _rag_agent, _linkol_agent, _hetu_agent, _mcp_agent, _hetu_mcp_agent, _collection_repo, _rag_agent_v2, _linkol_agent_v2, _hetu_agent_v2, _fortune_agent, _health_agent, _bazi_agent, _crypto_agent, _company_agent, _tarot_agent, _buffett_agent
    ...
    _tarot_agent = tarot_agent
    _buffett_agent = buffett_agent
...
def get_tarot_agent() -> TarotAgent:
    return _tarot_agent


def get_buffett_agent() -> BuffettAgent:
    return _buffett_agent
